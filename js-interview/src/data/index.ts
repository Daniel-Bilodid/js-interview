...
const RN_ORDER = [
  ...
  'rn-vs-react',
  'rn-core-components',
  'rn-safearea-touchable-wf',
  'rn-platform-specific-code',
  'rn-expo-vs-cli',
  'rn-threads',
  'rn-bridge',
  'rn-jsi',
  ...
  'rn-lists',
  'rn-multicolumn-lists',
  'rn-nested-scrollviews',
  'rn-animations',
  'rn-stack-navigator',
  'rn-navigation',
  'rn-stack-vs-screen',
  ...
  'rn-performance',
  'rn-usereducer',
  'rn-redux-perf-issues',
  'rn-yield-vs-promise-priority',
  'rn-testing-unit',
  'rn-testing-e2e',
  'rn-detox',
  'rn-eslint-tslint',
